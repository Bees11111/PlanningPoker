...
class EntrerBacklog(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.ajouter_button = tk.Button(entry_frame, text="Ajouter", command=self.ajouter_fonctionnalite)
        ...
        self.charger_fichier_button = tk.Button(self.button_row_frame, text="Charger depuis un fichier", command=self.load_backlog_from_file)
        self.charger_fichier_button.pack(side=tk.LEFT, pady=5)
        
        #Bouton pour sauvegarder le backlog
        self.sauvegarder_button = tk.Button(self.button_row_frame, text="Sauvegarder", command=self.sauvegarder_backlog)
        self.sauvegarder_button.pack(side=tk.LEFT, padx=5)

        #Bouton pour effacer la liste
        self.effacer_liste_button = tk.Button(self.button_row_frame, text="Effacer la liste", command=self.effacer_liste)
        ...
        self.commencer = tk.Button(self, text="  Commencer  ", command=self.show_cartes_jouer)
    ...
    def show_cartes_jouer(self):
        ...
        ChoixCartes(self.master, self.backlog).pack()