...
class TutorialMenu(tk.Frame):
    ...
    def create_widgets(self):
        ...
        tutorial_text2 = tk.Label(self, text="Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.", bg="#008080", fg="white")
        tutorial_text2.pack(pady=10)

        tutorial_text3 = tk.Label(self, text="Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.", bg="#008080", fg="white")
