...
from jouer_menu import pl_count

class ChoixCartes(tk.Frame):

    def __init__(self, master=None, backlog=None, player_count=pl_count, **kwargs):
    ...
    def afficher_carte(self, fichier_svg):
        print("svg="+fichier_svg)
        # Ajouter la carte à la liste du joueur actuel avec sa valeur
